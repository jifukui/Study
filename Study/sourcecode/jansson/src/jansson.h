...
/*json 结构体 由类型之和引用数量进行定义*/
/*volatile关键字的作用是不允许对此进行优化且每次读值需要直接读取其的值*/
...
#endif
/*内联函数，如果引用的次数不为-1，将此json对象的应用次数+1*/
...
/*内联函数，如果引用次数不为-1且引用次数减一之后为0删除json对象*/
